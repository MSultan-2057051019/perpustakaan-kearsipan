...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="container">
            <!-- <a class="navbar-brand" href="#">Dinas Perpus takaan dan Kearsipan</a> -->
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
        <img class="logo" src="assets/Logo.png" width="120" alt="Dinas Perpustakaan dan Kearsipan">
            <h1 class="display-4">Dinas Perpustakaan dan Kearsipan</h1>
            <p class="caption">Cari Berkas yang ingin anda temukan, hanya dengan satu kali klik, dimanapun dan kapanpun!</p>
            <a href="" class="button-30" role="button">Search&nbsp;<i>&#128269;</i></a>
        </div>
    </div>
          ...
          <div class="row justify-content-center">
            <div class="col-lg-4">
              <div class="row justify-content-center">
                ...
                <div class="col-6 panel-text">
                  <h4>24 Hours</h4>
                  <p>Lorem ipsum dolor sit amet sin.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4">
    ...
    <h1 class="text-center card-display">Berita Terbaru</h1>
      ...
      <div class="card-columns">
        <div class="card custom-card" style="border: none;">
          ...
          <div class="card-body">
            ...
            <p class="card-text"><small class="text-muted"><i class="fas fa-eye"></i>&nbsp;1000&nbsp;&nbsp;&nbsp;<i class="fas fa-calendar-alt"></i>&nbsp;Jan 20, 2018</small></p>
        </div>
          </a>
        </div>
        <div class="card custom-card" style="border: none;">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="d-block w-100" src="assets/car1.jpg" style="background: #C4C4C4;" alt="First slide">
      ...
      <div class="carousel-item">
        <img class="d-block w-100" src="assets/car2.jpg" style="background: #C4C4C4;" alt="Second slide">
        <div class="carousel-caption d-none d-md-block">
          <h5>Slide 2</h5>
          <p>Lorem ipsum dolor sit amet.</p>
        </div>
      ...
      <div class="carousel-item">
        <img class="d-block w-100" src="assets/car1.jpg" style="background: #C4C4C4;" alt="Third slide">
        <div class="carousel-caption d-none d-md-block">
          <h5>Slide 3</h5>
          <p> Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fugit impedit reiciendis quia laborum, rerum vitae corrupti magnam dolor doloremque sunt quisquam iusto quaerat ad et quo nobis, nesciunt eos ratione!</p>
        </div>
      </div>
    </div>
  ...
  <div class="row workingspace">
    <div class="col-lg-6">
      <img src="assets/car3.jpg" alt="workingspace" class="img-fluid">
    </div>
    <div class="col-lg-4">
      <h4 class="card-display">Tentang Kami</h4>
      <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Blanditiis nesciunt ipsa atque qui molestias fuga voluptate vel eligendi repellat nam porro perferendis excepturi harum dolores adipisci inventore, ab, tenetur delectus.</p>
    </div>
  </div>
  ...
  <footer class="text-center text-lg-start text-dark stripe-3">
    <!-- Grid container -->
    <div class="container p-4">
      ...
      <div class="row my-4">
        ...
        <div class="col-lg-5 col-md-6 mb-4 mb-md-0">
          <img src="assets/logo.png" height="120" alt="" loading="lazy" />
          <p class="text-center text-logo mt-3">Dinas Perpustakaan dan Kearsipan <br>Lampung Selatan</p>
        ...
        <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
          <h5 class="text-left text-title mb-4" style="width: 28%;">Lainnya</h5>

          <ul class="list-unstyled text-left">
            <li class="mb-2">
              <a href="#!" class="text-dark">General information</a>
            </li>
            <li class="mb-2">
              <a href="#!" class="text-dark">About the shelter</a>
            </li>
            <li class="mb-2">
              <a href="#!" class="text-dark">Statistic data</a>
            </li>
            <li class="mb-2">
              <a href="#!" class="text-dark">Job</a>
            </li>
            <li class="mb-2">
              <a href="#!" class="text-dark">Tenders</a>
            </li>
            <li class="mb-2">
        ...
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
          <h5 class="text-left text-title mb-4">Kontak kami</h5>
